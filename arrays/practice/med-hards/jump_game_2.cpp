...
// V Good, Greedy-Tricky Impl, https://leetcode.com/problems/jump-game-ii/
...
public:
    ...
    int min_count(int cur_pos, vector<int> &nums)
    { // gives min jumps needed to go from cur_pos to end
